...
| 2026-06-27 | nav/IA polish | shipped | footer removed site-wide -> social + résumé as top-right header icons (all viewports); résumé link added near top of /about; home gains an "Around the site" tl;dr guide; Resume dropped from mobile tab bar (now 4 tabs). Self-verified 390/1280, no overflow/console errors |
| 2026-06-27 | hamburger nav | shipped | sticky full-width top bar; header icons/links replaced by a Rosebud-style hamburger dropdown (Home/Posts/Travel/About/Résumé + GitHub/X/LinkedIn/Email, icon+text); removed redundant "Around the site" guide from home. Self-verified 390/1280: menu opens, header sticks (scrollY 700 -> header top 0), no overflow/console errors |
